...
extern int receivePayload;
extern char largeSendBuffer[255];
extern char smallSendBuffer[50];

typedef enum MessageType{
    FULL_ROUTING_TABLE_UPDATE, //0
    PARTIAL_ROUTING_TABLE_UPDATE, //1
    PARENT_DISCOVERY_REQUEST, //2
    PARENT_INFO_RESPONSE, //3
    CHILD_REGISTRATION_REQUEST, //4
    TOPOLOGY_BREAK_ALERT, //5
    TOPOLOGY_RESTORED_NOTICE,//6
    PARENT_RESET_NOTIFICATION,//7
    MIDDLEWARE_MESSAGE,//8
    DATA_MESSAGE,//9
    MONITORING_MESSAGE,//10
}MessageType;
